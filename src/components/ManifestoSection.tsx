  ...
  return (
    <section ref={containerRef} id="manifesto" className="relative min-h-[150vh] overflow-hidden bg-gradient-to-b from-black via-zinc-900 to-black">
      ...
      <div className="relative asymmetric-grid min-h-screen">
        ...
        <motion.div
          className="col-span-5 col-start-8 pt-32"
          style={{ y: y2 }}
        >
          <div className="clip-fragment bg-trio-red p-10 md:p-12">
            <p className="text-white text-xl md:text-2xl font-bold uppercase leading-relaxed">
              Provocar suor.<br/>
              Pulsar desejo.<br/>
              Causar desconforto.
            </p>
