      ...
      <div className="relative">
        {services.map((service, index) => {
          ...
          return (
            <motion.div
              key={index}
              className={`relative min-h-[60vh] md:min-h-[45vh] lg:min-h-[60vh] mb-8 md:mb-0 flex items-center ${
              ...
              <div className={`relative z-10 w-full max-w-4xl px-4 md:px-0 ${isEven ? 'md:ml-32' : 'md:mr-32'}`}>
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-8 md:gap-16 mt-3 md:mt-4">
                    ...
                    <div className={`md:border-l md:border-black/20 md:pl-16 ${index === 3 ? 'md:ml-4 lg:ml-6' : ''} flex items-center`}>
