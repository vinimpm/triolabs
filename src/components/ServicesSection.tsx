...
export default function ServicesSection() {
  ...
  return (
    <section ref={containerRef} id="servicos" className="relative min-h-[200vh] bg-gradient-to-b from-black via-zinc-900 to-black overflow-hidden">
      ...
      <div className="relative">
        {services.map((service, index) => {
          ...
          return (
            <motion.div
              key={index}
              className={`relative min-h-[60vh] md:min-h-[60vh] mb-8 md:mb-0 flex items-center ${
      ...
      <motion.div
        className="relative min-h-[60vh] md:min-h-screen flex items-center justify-center mt-12 md:mt-0"
        initial={{ opacity: 0 }}
