        ...
        <div className="space-y-16 md:space-y-8">
          ...
          >
            <div className="relative md:clip-angular bg-zinc-800/95 border-l-4 border-trio-red p-16 md:p-24 overflow-hidden">
              <span className="text-6xl md:text-8xl text-white/20 font-bold absolute top-12 left-4 md:top-16 md:left-8">01</span>
          ...
          >
            <div className="relative md:clip-fragment bg-zinc-800/95 border-r-4 border-trio-red p-16 md:p-24 overflow-hidden">
              <span className="text-6xl md:text-8xl text-trio-red/20 font-bold absolute top-8 right-4 md:top-12 md:right-8">02</span>
              <div className="relative z-10 md:text-right pt-12 md:pr-8">
          ...
          >
            <div className="relative md:clip-angular bg-zinc-800/95 border-l-4 border-trio-red p-16 md:p-24 overflow-hidden">
              <span className="text-6xl md:text-8xl text-white/20 font-bold absolute top-12 left-4 md:top-16 md:left-8">03</span>
              <div className="relative z-10 pt-12 md:pl-8">
          ...
          >
            <div className="relative md:clip-fragment bg-zinc-800/95 border-r-4 border-trio-red p-16 md:p-24 overflow-hidden">
              <span className="text-6xl md:text-8xl text-trio-red/20 font-bold absolute top-8 right-4 md:top-12 md:right-8">04</span>
              <div className="relative z-10 md:text-right pt-12 md:pr-8">
