    ...
    <section ref={containerRef} id="metodo" className="relative min-h-[200vh] bg-gradient-to-b from-black via-zinc-900 to-black overflow-hidden">
      ...
      <div className="relative mt-32 max-w-6xl mx-auto px-8">
        <div className="space-y-16 md:space-y-8">
          {/* Step 01 - Imersão */}
          <motion.div
            className="w-full md:w-2/3 md:ml-0 md:mr-auto"
            initial={{ opacity: 0, x: -50 }}
            animate={isInView ? { opacity: 1, x: 0 } : {}}
            transition={{ duration: 1 }}
          >
            <div className="relative md:clip-angular bg-zinc-800/95 border-l-4 border-trio-red p-16 md:p-24 overflow-hidden">
              <span className="text-6xl md:text-8xl text-white/20 font-bold absolute top-12 left-12 md:top-14 md:left-16">01</span>
          ...
          {/* Step 02 - Descoberta */}
          <motion.div
            className="w-full md:w-2/3 md:ml-auto md:mr-0"
            initial={{ opacity: 0, x: 50 }}
            animate={isInView ? { opacity: 1, x: 0 } : {}}
            transition={{ duration: 1, delay: 0.2 }}
          >
            <div className="relative md:clip-fragment bg-zinc-800/95 border-r-4 border-trio-red p-16 md:p-24 overflow-hidden">
              <span className="text-6xl md:text-8xl text-trio-red/20 font-bold absolute top-12 right-12 md:top-14 md:right-16">02</span>
          ...
          >
            <div className="relative md:clip-angular bg-zinc-800/95 border-l-4 border-trio-red p-16 md:p-24 overflow-hidden">
              <span className="text-6xl md:text-8xl text-white/20 font-bold absolute top-12 left-12 md:top-14 md:left-16">03</span>
              <div className="relative z-10 pt-12">
          ...
          {/* Step 04 - Evolução */}
          <motion.div
            className="w-full md:w-2/3 md:ml-auto md:mr-0 mb-32"
            initial={{ opacity: 0, x: 50 }}
            animate={isInView ? { opacity: 1, x: 0 } : {}}
            transition={{ duration: 1, delay: 0.6 }}
          >
            <div className="relative md:clip-fragment bg-zinc-800/95 border-r-4 border-trio-red p-16 md:p-24 overflow-hidden">
              <span className="text-6xl md:text-8xl text-trio-red/20 font-bold absolute top-12 right-12 md:top-14 md:right-16">04</span>
              <div className="relative z-10 md:text-right pt-12">
